...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/23 16:59:54.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/23 16:59:54. 
	*/
	...
	templateBuilder.Append("</a></cite>\r\n			<cite>");	templateBuilder.Append(TypeConverter.StrToDateTime(__spacepostrecommend.Postdatetime).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append("</a></p>\r\n			<p>日志:<em>" + __topcommentcountspaceinfo["postcount"].ToString().Trim() + "</em>   最后更新:<em>");	templateBuilder.Append(TypeConverter.StrToDateTime(__topcommentcountspaceinfo["updatedatetime"].ToString().Trim()).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append("</a></p>\r\n			<p>日志:<em>" + __topvisitedtimesspaceinfo["postcount"].ToString().Trim() + "</em>   最后更新:<em>");	templateBuilder.Append(TypeConverter.StrToDateTime(__topvisitedtimesspaceinfo["updatedatetime"].ToString().Trim()).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</em></p>\r\n		</li>\r\n		");
	}	//end if
