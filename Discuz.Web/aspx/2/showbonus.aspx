...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/23 16:59:48.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/23 16:59:48. 
	*/
	...
	templateBuilder.Append("						\r\n				<li><label>注册时间</label>");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Joindate).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</li>\r\n				");
	}	//end if
	...
	templateBuilder.Append("\r\n					<em>\r\n					发表于");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	...
	templateBuilder.Append(post.Poster.ToString().Trim());
	templateBuilder.Append("</a>发表于");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Postdatetime).ToString("yyyy-MM-dd hh:mm"));
	...
	templateBuilder.Append(valuablepost.Poster.ToString().Trim());
	templateBuilder.Append("</a>发表于");	templateBuilder.Append(TypeConverter.StrToDateTime(valuablepost.Postdatetime).ToString("yyyy-MM-dd hh:mm"));
	templateBuilder.Append("\r\n		</div>\r\n	</div>\r\n	<div class=\"postmessage\">\r\n		<div class=\"t_msgfont\">");
	...
	templateBuilder.Append("\" target=\"_blank\" onmouseover=\"showMenu(this.id,false)\" class=\"drop xg2\"  style=\"padding:0 14px 0 4px;\">");
	templateBuilder.Append(valueless.Poster.ToString().Trim());
	templateBuilder.Append("</a>发表于");	templateBuilder.Append(TypeConverter.StrToDateTime(valueless.Postdatetime).ToString("yyyy-MM-dd hh:mm"));
	templateBuilder.Append("\r\n		</div>\r\n	</div>\r\n	<div class=\"postmessage\">\r\n		<div class=\"t_msgfont\">");
