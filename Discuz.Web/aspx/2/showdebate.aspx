...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/23 16:59:53.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/23 16:59:53. 
	*/
	...
	templateBuilder.Append(TypeConverter.StrToDateTime(debatepost.Joindate).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append("<span>开始时间 <em>");	templateBuilder.Append(TypeConverter.StrToDateTime(debatepost.Postdatetime).ToString(" yyyy-MM-dd HH:mm"));
